...
public class ClientProgramController {
        ...
        try {
            ...
            if ( !httpSessionState.isUserLoggedIn() && !dataPart.getString("owner").equals("Roberta") && !dataPart.getString("owner").equals("Gallery") ) {
                ...
                if ( program != null ) {
                    ...
                    generateConfigurationIfNeeded(httpSessionState.getRobotFactory(), program.getProgramText(), configText);
        ...
        try {
            ...
            if ( jaxbImportExport != null ) {
                ...
                if ( robotType1.equals(robot) && robotType2.equals(robot) ) {
                    ...
                    generateConfigurationIfNeeded(httpSessionState.getRobotFactory(), programText, configText);
    ...
    private static void generateConfigurationIfNeeded(IRobotFactory robotFactory, String programText, String configText) {
        Project project =
            new Project.Builder()
